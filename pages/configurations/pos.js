    ...
    <Layout>
      <div style={{maxWidth:1100,margin:'0 auto',padding:'0 8px 40px'}}>
        ...
        <div style={{display:'flex',gap:8,marginBottom:14}}>
          {[['actif','POS Actif','#16a34a'],['inactif','POS Inactif','#dc2626']].map(([k,l,c])=>(
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',
          ...
          {[
            ...
            {v:pos.filter(p=>p.actif!==false).length, l:'Actif', c:'#16a34a'},
            {v:pos.filter(p=>p.actif===false).length, l:'Inactif',c:'#dc2626'},
        ...
        {loading ? (
          ...
          <div style={{textAlign:'center',padding:40,background:'white',
            borderRadius:12,color:'#aaa'}}>Aucun POS</div>
        ) : (
          ...
          <div style={{position:'fixed',inset:0,
            ...
            <div style={{background:'white',borderRadius:'20px 20px 0 0',
              ...
              <div style={{padding:'16px 20px'}}>
                ...
                <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
                  {inp(form,setForm,'prenomAgent','Prénom Agent','text','ex: Jean')}
                  {inp(form,setForm,'nomAgent','Nom Agent','text','ex: Pierre')}
                </div>
                ...
                <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
                  ...
                  <div>
                    <label style={{display:'block',fontWeight:700,fontSize:11,
                      color:'#555',marginBottom:3}}>Confirmer le mot de passe</label>
                ...
                <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:10}}>
                  <div>
                    <label style={{display:'block',fontWeight:700,fontSize:11,
                      color:'#555',marginBottom:3}}>Limite Crédit</label>
                  ...
                  <div>
                    <label style={{display:'block',fontWeight:700,fontSize:11,
                      color:'#555',marginBottom:3}}>Limite Balance Gains</label>
