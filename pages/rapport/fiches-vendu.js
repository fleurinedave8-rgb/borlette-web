      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:'0 8px 40px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:8,marginBottom:14}}>
          {[
            ...
            ['Vente Totale', `${fmt(tVente)}G`, '#16a34a'],
            ['Total Gagnants', `${fmt(tGanyan)}G`, '#dc2626'],
        ...
        <div style={{display:'grid',
          ...
          <div style={{background:'white',borderRadius:12,
            ...
            <table style={{width:'100%',borderCollapse:'collapse',fontSize:13}}>
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan={6} style={{padding:32,textAlign:'center',color:'#888'}}>⏳ Chargement...</td></tr>
                ) : paged.length===0 ? (
                  <tr><td colSpan={6} style={{padding:32,textAlign:'center',color:'#aaa'}}>
                    Aucun fich — klike 🔍 pou chèche
                  </td></tr>
                ) : paged.map((f,i)=>{
