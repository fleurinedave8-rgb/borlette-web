...
const getLabel = (nom='') => {
  ...
  if (MATIN_KLIYAN.some(k=>n.includes(k))) return 'Aujourd\'hui (Matin)';
  if (SOIR_KLIYAN.some(k=>n.includes(k)))  return 'Aujourd\'hui (Soir)';
  return 'Aujourd\'hui';
};
      ...
      <div style={{maxWidth:1000,margin:'0 auto',padding:'0 8px 40px'}}>
        ...
        {loading ? (
          ...
          <div style={{background:'white',borderRadius:12,padding:24,
            ...
            Aucun rezilta encore — Ale nan Lots Gagnant pou ajoute
          </div>
        ) : (
        ...
        <div style={{display:'grid',
          ...
          {[
            {v:stats.pos,      l:'Total POS',   bg:'#f59e0b',
              icon:'🖥️', onClick:()=>router.push('/configurations/pos')},
            {v:stats.posInactif,l:'POS Inactifs', bg:'#dc2626',
              icon:'❌', onClick:()=>router.push('/configurations/pos')},
            {v:stats.fiches,   l:'Fiches Vendues',bg:'#16a34a',
          ...
          <table style={{width:'100%',borderCollapse:'collapse',
            ...
            <thead>
              <tr style={{background:'#1e293b'}}>
                {['Date','Hè','Tirage','1er Lot','2ème Lot','3ème Lot',
                  'Traité pour Rapport'].map(h=>(
