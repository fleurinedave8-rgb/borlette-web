...
export default function SuccursalPage() {
  ...
  const TABS = [
    ...
    {k:'actif',   l:'✅ Liste Actif',  c:'#16a34a'},
    {k:'inactif', l:'⚠️ Liste Inactif',c:'#f59e0b'},
  ];
        ...
        {tab==='ajoute' && (
          <div style={{background:'white',borderRadius:12,padding:24,
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
              {inp2('prenomResponsable','Prénom Responsable','text','ex: Jean')}
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
              <div>
                <label style={{display:'block',fontWeight:700,fontSize:11,
                  color:'#555',marginBottom:4}}>Mot de passe</label>
              ...
              <div>
                <label style={{display:'block',fontWeight:700,fontSize:11,
                  color:'#555',marginBottom:4}}>Confirmer le mot de passe</label>
            ...
            {inp2('nomBanque','Nom Banque','text','ex: BNC')}
          ...
          <div>
            ...
            {loading ? (
              ...
              <div style={{textAlign:'center',padding:32,
                ...
                Aucun succursale {tab==='actif'?'aktif':'inaktif'}
              </div>
            ) : (
