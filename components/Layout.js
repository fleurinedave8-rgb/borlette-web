...
const NAV = [
  ...
  { href:'/succursal',  icon:'🏢', label:'Succursales' },
  { href:'/agents',     icon:'🖥️', label:'Agents / POS' },
  { href:'/tchala',     icon:'🔮', label:'Tchala' },
  { label:'Configurations', icon:'⚙️', sub:[
    { href:'/configurations/pos',            label:'Gestion POS' },
    ...
    { href:'/configurations/tete-fiche',     label:'Tête de fiche' },
  ...
  { label:'Surveillance', icon:'🔍', sub:[
    ...
    { href:'/surveillance/lots-gagnant',         label:'Lots gagnants' },
    { href:'/surveillance/fiches-agent',         label:'Fiches par agent' },
    { href:'/surveillance/controle-agent',       label:'Contrôle agent' },
    { href:'/surveillance/blocage-boule',        label:'Blocage numéros' },
    { href:'/surveillance/limites',              label:'Limites de mise' },
    { href:'/surveillance/pos-connectes',        label:'POS connectés' },
    { href:'/surveillance/tracabilite',          label:'Traçabilité' },
    { href:'/surveillance/demmande-elimination', label:'Demandes élimination' },
  ]},
  { label:'Rapports', icon:'📊', sub:[
    { href:'/rapport/fiches-vendu',      label:'Fiches vendues' },
    { href:'/rapport/fiches-gagnant',    label:'Fiches gagnantes' },
    { href:'/rapport/ventes-fin-tirage', label:'Ventes fin tirage' },
    { href:'/rapport/ventes-matin-soir', label:'Ventes matin/soir' },
    { href:'/rapport/journalier',        label:'Rapport journalier' },
    { href:'/rapport/fiches-elimine',    label:'Fiches éliminées' },
  ]},
  { href:'/paiement',  icon:'💳', label:'Paiements' },
